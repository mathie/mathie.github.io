...
wordpress_id: 337
wordpress_url: http://woss.name/2006/10/19/switching-to-gmail-from-dreamhost/
date: 2006-10-19 13:31:01.000000000 +01:00
categories:
- Geekery
tags:
- Geekery
...
- id: 631
  ...
  content: ! '<p>Sean: Yeah, DH has been useful for hosting various random bits and
    ...
    address in the message, isn''t it?  <em>checks<&#47;em> Hrm, yes, even with the
    apps for your domain, it sets the ''Sender'' to your primary address (mathie@woss.name
