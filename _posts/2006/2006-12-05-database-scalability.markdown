...
- id: 736
  ...
  content: ! '<p><37signals>Our setup: MySQL, lighttpd&#47;fcgi, Balance&#47;Pen,
    NFS, FreeBSD, and Red Hat Linux. We run our Rails apps on a 3-tier, 14-machine
    cluster (mainly AMD64)
...
- id: 737
  ...
  content: <p>Use PostgreSQL 8.2 (it DOES scale as opposed to MySQL - see for example
    http:&#47;&#47;pda.tweakers.net&#47;?reviews&#47;657 for details) and save yourself
    a lot of trouble.<&#47;p>
- id: 738
  ...
  content: ! '<p>We are doing replication for http:&#47;&#47;madame.lefigaro.fr but
    there are two major problems at the moment, as far as I know:
...
- id: 742
  ...
  content: ! '<p>Use http:&#47;&#47;www.keepalived.org&#47; and when one db goes down,
    you can switch dns and master&#47;slave threads. You then just connect to the
    db server from the web server via local dns<&#47;p>
...
- id: 743
  ...
  content: ! '<p>Your single points of failure are more numerous than just MySQL -
    ...
    <p>For me, MySQL scales well enough, but the Postgres&#47;MySQL flamewar could
    go on for ages. All I''d say is compile your kernel, database and as much code
    as possible with local optimisations and benchmark as much as possible. It always
...
- id: 751
  ...
  content: ! '<p>Hi,<&#47;p>
    ...
    that my company, Proven Scaling, offers consulting and architecture&#47;design
    for building scalable and reliable MySQL-based systems.  Our preferred design
    uses MySQL replication in combination with IP-takeover based failover.  If you''re
