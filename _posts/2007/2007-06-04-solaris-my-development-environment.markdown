...
- id: 857
  ...
  content: ! '<p>I''m the same, primary development on OS X but testing OS-specific
    features on Solaris 10 &amp; Linux using VMWare&#47;Parallels.  VMWare Fusion
    is "better" for running Solaris as it supports 64-bit, multiple CPUs and provides
    VMWare "Tools" for Solaris.  I haven''t look at Parallels 3 yet, though.<&#47;p>


    <p>To disable the graphical login in Solaris I use "&#47;usr&#47;dt&#47;bin&#47;dtconfig
    -d".  There''s probably many ways to achieve the same result.<&#47;p>
...
- id: 859
  author: Juan Lupi&Atilde;&sup3;n
